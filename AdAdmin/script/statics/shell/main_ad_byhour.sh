...
#ad clickd
./download.sh adwalker_ad_clickd $formatday $hour
./analysis.sh adwalker_ad_clickd $formatday $hour
./database.sh adwalker_ad_clickd $formatday $hour
...
#curl "http://192.168.10.235/control/adActualDay/dataImportSucceed.do"
