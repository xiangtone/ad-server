	...
	<form name="colloca" id="colloca" method="post" action="config!saveChannelConfig.do">
		 <fieldset class="search_fieldset" >
				<legend>配置信息 </legend>
					<table width="100%" >
						<tr>
							<td align="right" width="25%">渠道标示</td>
							<td>
							  <input name="channel" id="channel" maxlength="20"  value="" />
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								<input type="text" size="70"  name="url" id="url"  value=""/>
							</td>
						</tr>
						<tr>
							<td align="right">广告id参数名 ：</td>
							<td>
								<input type="text" name="adid_para" id="adid_para"  value=""/>
							</td>
						</tr>
						<tr>
							<td align="right">时间戳参数名 ：</td>
							<td>
								<input type="text" name="time_para" id=time_para  value=""/>
							</td>
						</tr>
						<tr>
							<td align="right">IP参数名 ：</td>
							<td>
								<input type="text" name="client_ip" id=client_ip  value=""/>
							</td>
						</tr>
						<tr>
							<td align="right">MAC参数名称：</td>
							<td>
								<input type="text" name="deviceid_para" id="deviceid_para"  value=""/>
							</td>
						</tr>
						<tr>
							<td align="right">OPENUDID参数名 ：</td>
							<td>
								<input type="text" size="50" name="openudid" id="openudid"  value=""/>
							</td>
						</tr>
						<tr>
							<td align="right">IDFA参数名 ：</td>
							<td >
								<input type="text" size="50"  name="idfa" id="idfa"  value="" />
							</td>
						</tr>
						<tr>
							<td align="right">IDFV参数名 ：</td>
							<td >
								<input type="text" name="idfv" id="idfv"  value="" />
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								<input type="text" name="pass_rate" id="pass_rate"  value="" /><span style="color:red">(0.0-1.0)</span>
							</td>
						</tr>
					</table>
					</fieldset>
