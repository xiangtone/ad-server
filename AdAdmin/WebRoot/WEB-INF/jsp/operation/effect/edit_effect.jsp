			...
			<div class="admin_right">
				<div class="content_right content_new">
					...
					<form name="update" id="confirm_form" method="post"	action="operation/addConfirmNum.do">
						<input name="effect_id" value="${id}" id="effect_id" type="hidden" />
						<table width="100%" cellpadding="0" cellspacing="1" id="tb"	class="table_bod1 font_stat">
							...
							<tr>
								...
								<td>
									...
									<input type="text" name="price" value="${vo.price}" /></td>
									<td><input type="text" name="confirm_num"  value="${vo.confirm_num}" /></td>
							</tr>
							</c:forEach>
							</c:if>	
						</table>
