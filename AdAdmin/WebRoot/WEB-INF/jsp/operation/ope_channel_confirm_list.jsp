...
function sumit_num() {
	...
	if (checkedLength > 0) {
		...
		$.ajax({
			url:'${pageContext.request.contextPath}/manage!submitCostNum.do',
			type:'post',
...
function sumit_num_not() {
	...
	if (checkedLength > 0) {
		...
		$.ajax({
			url:'${pageContext.request.contextPath}/manage!submitCostNumNot.do',
			type:'POST',
			data:'ids='+ids+"&inremark="+income_remarks,
			dataType:'text',
			beforeSend:function(){
			...
			<div class="admin_right">
				<div class="content_right content_new">
					<fieldset class="search_fieldset">
						<legend>渠道成本结算</legend>
						<div id="search_bar">
							<form action="manage!operationChannelConfirmList.do" method="post" id="channelConfirm">
								<div>
										...
										<td>
											<table width="100%">
												<tr>
													<td>渠道ID/名称</td>
													<td>
														<input name="channel" type="text" value="${bean.channel}" />
													</td>
													<td>发生时间</td>
													<td>
				...
				<form action="${pageContext.request.contextPath}/manage!submitCostNum.do" method="post" id="campaignInvoice">
