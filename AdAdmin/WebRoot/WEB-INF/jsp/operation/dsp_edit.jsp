	...
	<div class="main" style="background: #F6F6F6">
		<div class="content clearfix">
			<div class="content_right admin_right" >
				<form name="dspInfo" id="dspInfo" method="post" action="manage!updateDspInfo.do">
					<input name="dsp_id" id="dsp_id" value="${vo.dsp_id}" type="hidden"/>
					<table width="500px;">
						<tr>
