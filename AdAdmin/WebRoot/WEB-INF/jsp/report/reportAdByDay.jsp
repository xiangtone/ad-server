...
function query(){
    editForm.action="manage!ReportAdByDay.do";
    editForm.submit();
}
					...
					<div class="main_table">
						<table width="100%" cellpadding="0" cellspacing="1"	class="font_stat" id="tb">
							<tr class="tr_td tb_head" style="background-color: rgb(232, 238, 247);">
								...
								<th style="white-space: nowrap; cursor: pointer;">激活转化率<order:order url='${pageInfo.url}'  orderName='ctra' orderMode='desc' base="${pageContext.request.contextPath}" /></th>
							</tr>
							<!-- 表头排序参数设置-->
							<!-- 报表数据部分-总和数据-->
							<tr class="">
