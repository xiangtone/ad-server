										...
										<td>
											<table width="100%">
												<tr>
													...
													<td colspan="" align="left">来源</td>
													<td colspan="1" align="left">
														<input name="res_type" value="${bean.res_type}"/> 
													</td>
						 						</tr>
												<tr>
					...
					<div class="main_table">
						<table width="100%" cellpadding="0" cellspacing="1"	class="font_stat" id="tb">
							<tr class="tr_td tb_head" style="background-color: rgb(232, 238, 247);">
								...
								<th style="white-space: nowrap; cursor: pointer;">来源<order:order url='${pageInfo.url}'  orderName='res_type' orderMode='desc' base="${pageContext.request.contextPath}" /></th>
