	...
	$("#devIncomeAuditList").click(
			function() {
				$("#devIncomeAudit").attr("action",
						"${pageContext.request.contextPath}/manage!financeIncomeConfirmlist.do").submit();
			});
	//  运营开发者收入审核list下载
			...
			<div class="admin_right">
				<div class="content_right content_new">
					<fieldset class="search_fieldset">
						<legend>平台成本</legend>
						<div id="search_bar">
							<form id="devIncomeAudit" name="devIncomeAudit" action="${pageContext.request.contextPath}/manage!financeIncomeConfirmlist.do" method="post">
								<table width="100%">
									<tr>
										<td>
											<table width="100%">
					...
					<form id="batchForm" action="${pageContext.request.contextPath}/finance/devIncomeStatus.do" method="post">			
						<table width="100%" cellpadding="0"cellspacing="1" class="font_stat" id="tb">
							<tr class="tr_td tb_head">
								...
								<th width="10%" >网站主确认佣金<order:order url='${pageInfo.url}'  orderName='confirmMoney' orderMode='desc' base="${pageContext.request.contextPath}" /></th>
							</tr>
								...
								<tr>
									...
									<td align="center">
										<escore:formatMoney value="${summary.sum_sumMoney}" maxFractionDigits="2" />
									</td>
								</tr>
