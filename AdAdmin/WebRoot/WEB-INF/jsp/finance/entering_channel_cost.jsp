...
<script type="text/javascript">
	...
	dg.addBtn("save","保存",function(){ 
		if(vaildateForm("saveChannelCost")){
			$("#saveChannelCost").ajaxSubmit(function(data){
					if(data){
	 ...
	 dg.SetCancelBtn('关闭',function(){
			var id = document.getElementById("id").value;
			 var url = "manage!deleteChannelCostDay.do?id="+id;
	...
	<div class="main">
		<div class="content clearfix">
			<div class="content_right admin_right">
				<form name="saveChannelCost" id="saveChannelCost" method="post" action="manage!saveChannelCostDay.do">
					<div>
							...
							<td>
								<table>
									...
									<tr>
										...
										<td  align="left">
											<input name="channel_name" type="text" id="channel_name"	value="${vo.channel_name}" readonly="readonly" disabled="disabled"/>
										</td>
