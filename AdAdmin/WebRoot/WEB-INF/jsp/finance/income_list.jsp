...
<script type="text/javascript">
	$(document).ready(function() {
		$("#incomeReport").click(
		function() {
			$("#income").attr("action", "${pageContext.request.contextPath}/finance/IncomeAccountList.do").submit();
		});
	});
</script>
</head>
			...
			<div class="admin_right">
				<div class="content_right content_new">
					<fieldset class="margtop10 mar_bom10">
						<legend>收入结算</legend>
						<div id="search_bar">
							<form action="${pageContext.request.contextPath}/finance/IncomeAccountList.do" method="post" id="income" name="income">
								<table width="100%">
									<tr>
										<td>
											<table width="100%">
												...
												<tr>
													...
													<td><select name="payment_status" style="width: 153px;">
														<option value="">全部</option>
														<option value="0" <c:if test="${bean.payment_status ==0}">selected="selected"</c:if>>未回款</option>
														<option value="1" <c:if test="${bean.payment_status ==1}">selected="selected"</c:if>>已回款</option>
													</select></td>
												</tr>
												<tr>
													<td>销售人员</td>
