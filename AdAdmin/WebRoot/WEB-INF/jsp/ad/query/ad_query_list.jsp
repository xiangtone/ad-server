			...
			<div class="admin_right">
				<div class="content_right content_new">
					<fieldset class="search_fieldset">
						<legend>广告查询 </legend>
						<div id="search_bar">
							<form action="manage!adQuery.do" id="my_form" method="post">
								<table width="100%">
									<tr>
										<td>
											<table width="100%">
										...
										<tr>
											...
											<td>文件名称</td>
											<td>
												<input type="text" name="file_name" value="${bean.file_name}" />
											</td>
										</tr>
										<tr>
											<td>媒体类型</td>
						...
						<c:if test="${!empty list}">
							<c:forEach items="${list}" var="vo" varStatus="status">
								<tr>
									...
									<td>
										<escore:subStr len="15" value="${vo.placement_name}" />
									</td>
									<td>
										<escore:subStr len="30" value="${vo.file_name}" />
									</td>
									<td>
										<escore:subStr len="30" value="${vo.code}" />
									</td>
									<td>
										<c:choose>
