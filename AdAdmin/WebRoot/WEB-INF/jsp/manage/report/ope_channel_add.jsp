			...
			<div class="content clearfix">
				...
				<div class="admin_right">
					...
					<div class="bord_bom1px">
						<a href="manage!channelsManage.do">渠道管理</a>>添加渠道
					</div>
					...
					<table>
						<tr>
							...
							<td>
								<input name="cp_id" value="${newsNotice.cp_id }"  type="text" id="cp_id" style="width: 350px"  maxlength="31"/>
							</td>	
						</tr>
						<tr>
							<td>
...
<span class="clear_span" style="height: 280px;"></span>
</div>
</div>
