...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/jquery.form.js?v=${version}" charset="utf-8"></script>
	...
	dg.addBtn("save","保存",function(){
		if(vaildateForm("updateDevPunishDetail")){
			$("#updateDevPunishDetail").ajaxSubmit(function(data){
				if(data){
	...
	<div class="main">
		<div class="content clearfix">
			<div class="admin_right">
				...
				<div class="">网站主扣款明细</div>

				<form id="updateDevPunishDetail" name="updateDevPunishDetail" method="post" action="manage!updateDevPunishDetail.do">
						<table>
							<tr>
							...
							<tr>
								<td><font style="margin-right: 11px;" color="blue">扣款原因:</font></td>
