			...
			<div class="admin_right">
				<div class="content_right content_new">
					<fieldset class="search_fieldset">
						<legend>销售管理 </legend>
						<div id="search_bar">
							<form action="salesmanList.do" id="my_form" method="post">
								<table width="100%">
									<tr>
										<td>
											<table width="100%">
												<tr>
													...
													<td>
														<select name="area_type" id="adForm">
															...
															<option value="2" <c:if test="${bean.area_type ==2}"> selected="selected"</c:if> >华北</option>
															<option value="1" <c:if test="${bean.area_type ==1}"> selected="selected"</c:if> >华东</option>
															<option value="4" <c:if test="${bean.area_type ==4}"> selected="selected"</c:if> >华南</option>
														</select>
													</td>
												</tr>
											</table>
