		...
		<div class="content clearfix">
			<div class="admin_right">
				<div class="content_right content_new">
					<form name="editForm" id="editForm" action="manage!editItem.do" method="post">
						<table width="98%" border="0" align="center" cellpadding="0" cellspacing="1" bordercolor="#999999" class="style_table">
							...
							<tr>
								...
								<td>
									<input name="sqlName" id="sqlName" value="${data.sqlName}" /><font color="red">${wrong_message.sqlName_error}</font>
								</td>
							</tr>
							<tr>
								<td>页面名称:</td>
							...
							<tr>
								<td>页面显示类型<font color="red">(只有在为搜索时生效)</font>:</td>
							...
							<tr>
								<td>是否为链接:</td>
								<td><select id="isLink" name="isLink">
										<option value="">请选择</option>
										<option value="n"
											<c:if test="${data.isLink=='n'}">selected</c:if>>否</option>
										<option value="y"
											<c:if test="${data.isLink=='y'}">selected</c:if>>是</option>
								</select><font color="red">${wrong_message.isLink_error}</font>
								</td>
							</tr>
							<tr>
