...
public class InvoiceSumVo {
	...
	public InvoiceSumVo(Double sum_balance, Double sum_invoice_money,
			Double sum_income_money, Double sum_bad_money,
			Double sum_circle_money,Double sum_not_circle_money) {
		super();
