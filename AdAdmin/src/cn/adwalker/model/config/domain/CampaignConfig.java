...
public class CampaignConfig implements Serializable{
  /**
	 * 
	 */
  private static final long serialVersionUID = 8877354781332345477L;
  private Long id;				//id
  ...
  private Double adv_price;			//广告价格
  private String sourse_str;		//额外的参数如source
  ...
  private Integer is_online;		//是否在线0是上线，1是下线
  private Double pass_rate;			//通过率
  private String udid;				//mac参数名
