...
/**
* <p>Title: FinanceChaApplyMoneyDaoImpl</p>
* <p>Description:渠道提款dao实现类</p>
* <p>Company: adwalker</p> 
* @author   lichuang
* @date       2014-2-17
 */
@Repository("financeChaApplyMoneyDao")
public class FinanceChaApplyMoneyDaoImpl extends BaseDaoImpl implements IFinanceChaApplyMoneyDao {
	...
	* @return
	* @throws Exception
	* @see cn.adwalker.model.finance.dao.IFinanceChaApplyMoneyDao#getById(java.lang.Long)
	 */
	@SuppressWarnings("unchecked")
	public ChaApplyMoney getById(Long id) throws Exception {
		StringBuffer sql = new StringBuffer();
		sql.append("SELECT * FROM v_cha_apply_money WHERE ID = ?");
		return (ChaApplyMoney) jdbcTemplate.queryForObject(sql.toString(), new BeanPropertyRowMapper(ChaApplyMoney.class), id);
	}
	...
	public List<DevApplyMoney> findReport(String con, int tag) throws Exception {
		...
		return this.jdbcTemplate.query(sql.toString(), new BeanPropertyRowMapper(DevApplyMoney.class));
	}
	...
	@Override
	public void batchAuditInFinance(List<ChaApplyMoney> chaApplyMoneyList) throws Exception {
		StringBuffer sql = new StringBuffer();
	...
	public void batchFinance_TaxAndDues(List<ChaApplyMoney> updateList) {
		...
		sql.append(" where ID = ? ");// 条件
		List<Object[]> parameters = new ArrayList<Object[]>();
		for (ChaApplyMoney bean : updateList) {
