package cn.adwalker.upload.service.impl;
...
import cn.adwalker.upload.service.UploadService;
import cn.adwalker.upload.vo.image.FallVO;
import cn.adwalker.upload.vo.image.SucceedVO;
...
public class ImageUploadService extends UploadService {
	...
	public Map<String, Object> uploadImage(String policy, String path, String isCover, String canCut, String zoomSize, HttpServletRequest request) {
		...
		// int size = MathUtil.getSize(imgList);
		// if (size > c) {
