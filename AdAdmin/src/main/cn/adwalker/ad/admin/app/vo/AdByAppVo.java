...
public class AdByAppVo {
	...
	private List<PlacementPackage> packages;
	...
	public List<PlacementPackage> getPackages() {
		return packages;
	}

	public void setPackages(List<PlacementPackage> packages) {
