...
/**
* <p>Title: ChannelCensusGeneralViewVo</p>
* <p>Description:渠道总数据表</p>
* <p>Company: adwalker</p> 
* @author   lichuang
* @date       2013-5-18
 */
public class ChannelCensusGeneralViewVo {
	/** 主键ID */
	private Long id;
	/** 时间 */
	...
	public BigDecimal getGross_profit_margin() {
		if(this.profit_money!=null && this.sum_cost_price!=null && this.sum_cost_price!=BigDecimal.valueOf(0)){
			gross_profit_margin=MathUtil.multiplyInt(MathUtil.divideBig(this.profit_money,this.sum_cost_price),100d);
		}
