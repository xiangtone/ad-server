...
* @date       2013-10-11
 */
public class ChannelCampaignConfirmSumVo {
	...
	public ChannelCampaignConfirmSumVo() {
		super();
	}

	public ChannelCampaignConfirmSumVo(Double sum_income_money,Double sum_forecast_money,Integer sum_forecast_amount) {
		super();
