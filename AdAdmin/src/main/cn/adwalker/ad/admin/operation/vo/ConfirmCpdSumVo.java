...
/**
* <p>Title: ConfirmCpdSumVo</p>
* <p>Description:Cpd求和Vo</p>
* <p>Company: adwalker</p> 
* @author   lichuang
* @date       2013-10-12
 */
public class ConfirmCpdSumVo {
	private Double sum_forecast_money;//总预计金额 统计
	private Double sum_income_money;//总金额 统计
	private Integer sum_channel_num;//总数渠道

	
	public ConfirmCpdSumVo() {
		super();
	}

	public ConfirmCpdSumVo(Double sum_income_money,Double sum_forecast_money,Integer sum_channel_num) {
		super();
