...
public class Ad implements Entity {
	 ...
	 * 区域定向
	 */
	private String area_directional_str;

	/**
	 * 应用类型
	 */
	private String app_type_str;
	 ...
	 * 时段定向
	 */
	private String time_directional_str;

	/**
	 * 
	 */
	private String phone_brand_str;
	/**
	 * 运营商
	 */
	private String operat_agencies_str;
	/**
	 * sdk版本
	 */
	private String sdk_version_str;
