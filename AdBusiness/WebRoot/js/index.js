$(function(){
    ...
    window.onresize = function(){
        ...
        $(".section").css({"-ms-transform": "translate3d(0,"+(-(currentpage-1)*winh)+"px,0)"});
    }
    ...
    $(".tag-list ul li").each(function(index) {
        $(this).click(function(){
            ...
            $(".section").css({"-ms-transform": "translate3d(0,"+(-index*winh)+"px,0)"});
            currentpage = index+1;
    ...
    $(document).keydown(function(event){
        ...
        if(event.keyCode == 38){    //上
            if(currentpage != 1 && isscroll){
                ...
                $(".section").css({"-ms-transform": "translate3d(0,"+(-(currentpage-2)*winh)+"px,0)"});
                currentpage --;
...
//				}
            ...
            if(currentpage != pagecount && isscroll){
                ...
                $(".section").css({"-ms-transform": "translate3d(0,"+(-currentpage*winh)+"px,0)"});
                currentpage ++;
//				if(currentpage == pagecount){
//					$("html,body").css("overflow","visible");
//				}
    ...
    function scrollEvent(e){
        ...
        if(e.wheelDelta > 0 || e.detail < 0){       //此处向上的动作
            ...
            if(currentpage != 1 && isscroll){
                ...
                $(".section").css({"-o-transform": "translate3d(0,"+(-(currentpage-2)*winh)+"px,0)"});
                $(".section").css({"-ms-transform": "translate3d(0,"+(-(currentpage-2)*winh)+"px,0)"});
                $(".section").css({"-webkit-perspective": "1000"});
                $(".section").css({"-moz-perspective": "1000"});
                $(".section").css({"perspective": "1000"});
                currentpage --;
//				if(currentpage == pagecount){
//					$("html,body").css("overflow","hidden");
//				}
