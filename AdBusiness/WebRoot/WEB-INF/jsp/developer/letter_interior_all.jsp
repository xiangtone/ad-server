				...
				<div class="table-products section">
					<div class="row ctrls">
						<ul class="nav nav-tabs">
							<li class="active"><a href="#all" onclick="interiorall();">全部信件（${count_hava}）</a></li>
							<li><a href="#unread"  onclick="interiorNot(0);">未读信件（${count_not }）</a></li>
						</ul>
									...
									<ul class="table table-hover">
										<c:if test="${!empty list}">
											<c:forEach items="${list}" var="aml" varStatus="status">
												<li>
													<dl>
														<dt class="message-header clearfix" style="font-weight: normal;" id="orag">
															<span class="message-title">【公告】${aml.title}</span> <span class="pull-right" style="margin-right: 5px;" data-msg-id="#"> <a href="javascript:void(0)" id="d_b" class="view-message">查看详情&gt;</a> <a href="javascript:void(0)" class="delete delete-message" onclick="delm(${aml.id});">删除</a>
															</span>
														</dt>
														<dd style="display: none;" class="message-content">
