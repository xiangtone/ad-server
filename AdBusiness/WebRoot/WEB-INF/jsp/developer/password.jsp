			...
			function submitForm() {
				if (vaildateForm("myForm")) {
					$("#myForm").ajaxSubmit(function(data) {
						if (data == "true") {
							alert("修改成功！！");
							window.location.href = 'toUpdatePassword.action';
						} else {
							alert("修改失败，请重试！！");
						}
					});
				...
				<div class="table-products section">
					...
					<div class="row filter-block">
						<div class="personal-info">
							<form class="form-horizontal" role="form" name="updateUserPass" action="updateUserPass.action" method="post" id="myForm">
