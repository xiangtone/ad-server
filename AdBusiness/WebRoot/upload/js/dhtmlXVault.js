...
dhtmlXVaultObject.prototype.create = function(htmlObject)
{
    ...
    var str = "<table style='background-color:#EDEEEF;border: 1px solid #7A7C80;' border='0'>" +
              ...
              "<img _onclick='UploadControl.prototype.uploadAllItems()' _ID='ImageButton3'  src='"+rootPath+"imgs/btn_upload.gif' style='cursor:pointer'/></td>" +
              "<td style='width: 140px; height: 32px;' align='right'>" +
              "<img _onclick='return UploadControl.prototype.removeAllItems()' _ID='ImageButton3'  src='"+rootPath+"imgs/btn_clean.gif' style='cursor:pointer;margin-right:20px'/></td></tr></table>" +

              "<div _id='fileContainer' style='width:84px;overflow:hidden;height:32px;left:0px;direction:rtl;position:absolute;top:211px'>" +
              "<img style='z-index:2' src='"+rootPath+"imgs/btn_add.gif'/>" +
...
{
    //-------------------------------------------
    var srcImgPic = rootPath+"imgs/ico_image.png";
    var srcImgVideo = rootPath+"imgs/ico_video.png";
    var srcImgSound = rootPath+"imgs/ico_sound.png";
    var srcImgArchives = rootPath+"imgs/ico_zip.png";
    var srcImgFile = "rootPath+imgs/ico_file.png";
...
{
    var srcImgProgress = rootPath+"imgs/pb_demoUload.gif";
