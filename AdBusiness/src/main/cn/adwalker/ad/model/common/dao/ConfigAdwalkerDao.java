...
public class ConfigAdwalkerDao {
  ...
  public ConfigEScore getPlatformConfig() {
    ...
    List<ConfigEScore> list = namedParameterJdbcTemplate.query(sql.toString(), new BeanPropertyRowMapper<ConfigEScore>(
        ConfigEScore.class));
  ...
  public ConfigFinance getFinanceConfig(int status) {
    ...
    List<ConfigFinance> list = namedParameterJdbcTemplate.query(sql.toString(),
