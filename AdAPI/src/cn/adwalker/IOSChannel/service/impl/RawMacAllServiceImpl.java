...
/**
 * <p>添加了ios版本,mac 
 * 	       要原生的值包含02:00:00:00:00:00</p>
 * @author jief
 *
 */
public class RawMacAllServiceImpl implements ISendClickService{
private static final Logger log=Logger.getLogger(RawMacAllServiceImpl.class);
	
	public static RawMacAllServiceImpl waBangService=null;
	private RawMacAllServiceImpl(){}
	public static RawMacAllServiceImpl getInstance(){
	   if(waBangService==null){
		   synchronized (RawMacServiceImpl.class) {
			   waBangService=new RawMacAllServiceImpl();
		   }
		}
		return waBangService;
	}
	@Override
...
//		params.append(ios.getUrl()).append("?")
		params.append(ios.getDeviceid_para()).append("=")
		      .append(StringUtil.formatMac(StringUtils.isBlank((vo.getDeviceId()))?"020000000000":vo.getDeviceId()))
		...
		params.append("&version=").append(vo.getOs_version());
