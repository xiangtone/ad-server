...
/**
 * <p>发送原始mac，ios7mac为空</p>
 * @author jief
 *
 */
public class RawMacServiceImpl implements ISendClickService{
	private static final Logger log=Logger.getLogger(RawMacServiceImpl.class);
	
	public static RawMacServiceImpl rawMacService=null;
	private RawMacServiceImpl(){}
	public static RawMacServiceImpl getInstance(){
	   if(rawMacService==null){
		   synchronized (RawMacServiceImpl.class) {
			   rawMacService=new RawMacServiceImpl();
		   }
		}
		return rawMacService;
	}
	@Override
