...
public class MemcacheCached {
	private static final Logger logger = Logger.getLogger(MemcacheCached.class);
	private static final String cache_url = ConfigUtil.getString("cache_url");
    private static MemcacheCached util = null;
	protected static MemCachedClient mcc = new MemCachedClient();

	public synchronized static MemcacheCached getInstance(){
		if(null==util){
			util = new MemcacheCached();
		}
		return util;
	}
	static {
        logger.logInfo("building memcache............"+cache_url);
...
//		mcc.setCompressThreshold(64 * 1024);
	...
	public boolean add(String key,Object value,Integer second){
		return mcc.add(key, value, second);
	}
	public boolean cas(String key,Object value,Integer second){
		return mcc.cas(key, value, second);
	}
