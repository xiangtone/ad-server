...
/**
 * @author www.adwalker.com.cn luo
 * map to bean
 */
public class BeanMapConvent  {
	...
	public <T> T toBean(Map<String, String> paraMap, Class<T> type) {
		PropertyDescriptor[] props = this.propertyDescriptors(type);
		return createBean(paraMap, type, props);
	}
	...
	private <T> T createBean(Map<String, String> map, Class<T> type,PropertyDescriptor[] props) {
