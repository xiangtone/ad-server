...
<html> 
	...
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/detail-jifen.css" />
	<script src="${pageContext.request.contextPath}/js/base64.js"></script>
	<script src="${pageContext.request.contextPath}/js/jquery-1.7.1.min.js"></script>	
	<script src="${pageContext.request.contextPath}/js/global.js"></script>
	<script src="${pageContext.request.contextPath}/js/detail-jifen.js"></script>
</head> 
<body> 
 <div id="detailjifen">
	<div class="toptitle">
	...
	<div id="detailcontent" class="detailcontent">	
		<div id="content" class="content"> 	
			...
			<div class="rightcontent">
				<img  class="renzheng" id="renzheng" src="../images/jfrenzheng.png"><span class="rzword">安全认证</span>
			</div>
		</div>
		<div class="divider" id="divider"></div>
		<div id="detailintroduce" class="detailinfo">
		...
		<div id="extend" class="extend" onclick="senfe()"><img id="extendImage" class="extendImage" src="../images/jfzhankai.png" ></div>
		...
		<div id="bottomId2">
				<div id="bigDownload2" class="bigdownload2"><img  id="downloadlogo" class="downloadlogo" src="../images/jifendownload02.png"><span id="downloadword2" class="downloadword">立即下载</span></div>
<!-- 				<div id="shareDiv" class="shareDiv2"><img id="share" class="share" src="../images/jfshare.png" height="30"></div> -->
		</div>
		</div>
</div>
		<div id="bottomId">
				<div id="bigDownload" class="bigdownload"><img  id="downloadlogo" class="downloadlogo" src="../images/jifendownload02.png"><span id="downloadword" class="downloadword">立即下载</span></div>
<!-- 				<div id="shareDiv" class="shareDiv"><img id="share" class="share" src="../images/jfshare.png" height="30"></div> -->
		</div>
		...
		<input type="hidden" id="introduceInfo" value="${detail.score_msg }">
		<input type="hidden" id="isDownload" value="${isDownload }">
		...
		<input type="hidden" id="catagory" value="${detail.detail_fourth}">	
		...
		<input type="hidden" id="resourceSize" value=versionesourceSize}">
