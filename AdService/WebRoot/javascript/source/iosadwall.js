...
//		downloadDiv.appendChild(downMiddle);
		...
		downBottom.innerHTML = "<div class='downIconbgroung' id='downIconbgroung"+index+"'></div><div class='downbgroung' id='downbgroung"+index+"'><span id='freeword"+index+"' class='freeword'>"+downword+"</span></div>";
		downloadDiv.appendChild(downBottom);
		
		boxRDiv.appendChild(downloadDiv);
		boxRDiv.addEventListener('click', function() {
